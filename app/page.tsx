            ...
            <CustomerReviews reviews={[
                {
                    ...
                    author: "Анна С.",
                    rating: 5,
                    text: "Отличный сервис! Быстро и надежно. Рекомендую всем, кто ценит качество и скорость."
                },
                {
                    id: 2,
                    author: "Иван П.",
                    rating: 4,
                    text: "Хороший опыт, но есть небольшие замечания. В целом, сервис на высоте."
                },
                {
                    id: 3,
                    author: "Елена М.",
                    rating: 5,
                    text: "Превосходно! Всем рекомендую. Лучший банковский сервис, с которым я сталкивалась."
                },
                {
                    id: 4,
                    author: "Сергей К.",
                    rating: 4,
                    text: "Удобно и быстро. Есть над чем работать, но уже сейчас очень достойно."
                },
                {
                    id: 5,
                    author: "Ольга В.",
                    rating: 5,
                    text: "Лучший банковский сервис, которым я пользовалась! Все функции работают отлично."
                },
                {
                    id: 6,
                    author: "Дмитрий Л.",
                    rating: 4,
                    text: "Хорошее обслуживание, но хотелось бы больше функций. В целом, доволен."
                },
                {
                    id: 7,
                    author: "Мария Н.",
                    rating: 5,
                    text: "Очень довольна! Всё работает как часы. Интерфейс понятный и удобный."
                },
                {
                    id: 8,
                    author: "Алексей Р.",
                    rating: 4,
                    text: "Надежно и безопасно. Рекомендую. Служба поддержки всегда на высоте."
                },
                {
                    id: 9,
                    author: "Татьяна Ш.",
                    rating: 5,
                    text: "Отзывчивая поддержка и удобный интерфейс. Очень довольна сервисом."
                },
