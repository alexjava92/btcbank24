                ...
                <CustomerReviews reviews={[
                    {
                        ...
                        author: "Артём Б.",
                        rating: 5,
                        text: "Очень удобный сервис! Всё просто и понятно, никаких лишних действий. Деньги пришли на счёт буквально за 10 минут."
                    },
                    {
                        id: 2,
                        author: "Анастасия К.",
                        rating: 5,
                        text: "Сначала переживала, но всё прошло гладко. Обменяла биткоины на рубли без проблем, сервис действительно быстрый и удобный."
                    },
                    {
                        id: 3,
                        author: "Дмитрий Л.",
                        rating: 4,
                        text: "Обмен прошел быстро, но было бы здорово, если бы добавили больше способов вывода. В остальном всё отлично."
                    },
                    {
                        id: 4,
                        author: "Мария Н.",
                        rating: 5,
                        text: "Пользуюсь уже не первый раз. Всё стабильно и чётко, поддержка всегда на связи, если есть вопросы. Рекомендую."
                    },
                    {
                        id: 5,
                        author: "Алексей Р.",
                        rating: 4,
                        text: "Сервис отличный, но хотелось бы чуть быстрее обработку заявок. В остальном всё прозрачно и понятно."
                    },
                    {
                        id: 6,
                        author: "Ольга В.",
                        rating: 5,
                        text: "Спасибо за отличный сервис! Обмен быстрый, поддержка вежливая, всё проходит без лишних вопросов."
                    },
                    {
                        id: 7,
                        author: "Иван П.",
                        rating: 4,
                        text: "Всё понравилось, удобный бот в Telegram. Немного волновался, но деньги пришли точно в срок."
                    },
                    {
                        id: 8,
                        author: "Татьяна Ш.",
                        rating: 5,
                        text: "Очень удобный сервис, работает без сбоев. Всё интуитивно понятно, а скорость обмена приятно удивила."
                    },
                    {
                        id: 9,
                        author: "Сергей К.",
                        rating: 5,
                        text: "Рекомендую! Быстро, удобно, а главное — безопасно. Всё прошло на высшем уровне."
                    },
